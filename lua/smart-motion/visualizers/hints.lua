...
---@param ctx table Full context (cursor position, buffer, etc.) ΓÇö not used here, but part of standard signature.
---@param cfg table Validated config (keys, highlights, etc.) ΓÇö needed for base_keys.
